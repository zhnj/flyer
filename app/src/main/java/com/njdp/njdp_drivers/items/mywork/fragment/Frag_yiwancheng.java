...
import com.njdp.njdp_drivers.items.mywork.adapter.YiwanchengAdapter;
...
public class Frag_yiwancheng extends Fragment {
    ...
    private void initData() {
        ...
        url = url + "?pageNo=" + curr + "&limit=3&flyer_id="+flyer_id+"&work_state=2";
        Log.i("url",url);
        //定义一个StringRequest
