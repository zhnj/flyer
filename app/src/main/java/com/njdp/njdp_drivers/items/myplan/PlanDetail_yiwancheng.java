...
public class PlanDetail_yiwancheng extends AppCompatActivity {
    RecyclerView rv;
...
//        }
    ...
    private void initView() {
        ...
        DetialAdapter_yiwancheng adapter = new DetialAdapter_yiwancheng(planDetailBean.getResult());
